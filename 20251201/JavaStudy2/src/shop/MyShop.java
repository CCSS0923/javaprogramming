...
public class MyShop implements IShop{
	...
	User[] users = new User[2];    // 등록 회원 정보 배열
	
	
	Product[] products = new Product[4];   // 등록 상품 정보 배열
	...
	public void start() {
		...
		for(User u : users) {           // 등록된 사용자 정보 출력
	...
	public void genProduct() {
		CellPhone cp = new CellPhone("갤럭시 노트5",100,"SKT");
		products[0] = cp;
		cp = new CellPhone("애플 아이폰7",980,"KT");
		products[1] = cp;
		SmartTV st = new SmartTV("삼성 3D Smart TV",500,"4K");
		products[2] = st;
		st = new SmartTV("LG Smart TV",250,"Full HD");
		products[3] = st;
	}
}